...
public class VisualFxScreen extends Screen {
    ...
    private static final SldSection[] SLIDER_SECTIONS = new SldSection[]{
            ...
            new SldSection("镜头与特效强度", new Sld[]{
                    ...
                    new Sld("震屏上限", "cameraShakeCap", 0.5, 5, 1),
                    new Sld("FOV上限", "cameraFovKickCap", 1, 12, 1),
                    new Sld("顿帧上限", "cameraHitstopCap", 0, 10, 0),
    ...
    private static final Page[] PAGES = new Page[]{
            new Page("镜头·特效", new Section[]{
                    ...
                    new Section("闪光 / 粒子 / 音效", new Btn[]{
                            ...
                            new Btn("入包音·开", "yongye config set enablePickupSound true"),
                            new Btn("入包音·关", "yongye config set enablePickupSound false"),
                            new Btn("入包音·轻0.4", "yongye config set pickupSoundVolume 0.4"),
                            new Btn("入包音·默认0.8", "yongye config set pickupSoundVolume 0.8"),
            ...
            new Page("姿态·怪物", new Section[]{
                    ...
                    new Section("疾跑残影(m433:当前姿态在身后画渐隐副本,非骨骼回放)", new Btn[]{
                            ...
                            new Btn("层数·1", "yongye config set sprintAfterimageLayers 1"),
                            new Btn("层数·3", "yongye config set sprintAfterimageLayers 3"),
                            new Btn("层数·4", "yongye config set sprintAfterimageLayers 4"),
                            new Btn("间距·紧0.14", "yongye config set sprintAfterimageSpacing 0.14"),
                            new Btn("间距·默认0.22", "yongye config set sprintAfterimageSpacing 0.22"),
                            new Btn("间距·散0.35", "yongye config set sprintAfterimageSpacing 0.35"),
                            new Btn("浓度·淡40", "yongye config set sprintAfterimageAlpha 40"),
                            new Btn("浓度·默认70", "yongye config set sprintAfterimageAlpha 70"),
                            new Btn("浓度·浓110", "yongye config set sprintAfterimageAlpha 110"),
                    }),
