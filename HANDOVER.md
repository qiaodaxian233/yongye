...
- **项目完成度(估)≈ 94%**:核心玩法、成长线、世界节奏、Boss、HUD、饰品栏、时间进度、职业系统、天赋树、职业专属技能、职业专属武器、开局选职业均已落地;余下主要是真·主动技能(keybind 触发)、天赋 GUI、选职界面贴图化、坦克专属盾、职业/天赋数值平衡、若干美术占位替换。
...
- **坦克专属盾(已设计待做)**:副手装备,与主手镇魂成套;持盾叠护甲/韧性/击退抗性+强化护盾或加格挡反震。做法=继承 `ShieldItem`(功能易),3D 盾面模型/贴图是特殊管线(较费),拟先功能版后精修。
